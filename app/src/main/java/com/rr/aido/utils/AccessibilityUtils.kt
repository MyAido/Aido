...
/**
 * AccessibilityUtils - Accessibility service status check karne ke liye
 */
object AccessibilityUtils {
    ...
    fun isAccessibilityServiceEnabled(context: Context): Boolean {
        ...
        // Debug log - yeh dekhne ke liye ki actual kya service name hai
    ...
    /**
     * Check if Aido keyboard is enabled in system settings
     */
    ...
    /**
     * Check if Aido keyboard is currently active
     */
    ...
    /**
     * Redirect user to Input Method settings to enable Aido keyboard
     */
    ...
    /**
     * Show input method picker to let user select Aido keyboard
     */
